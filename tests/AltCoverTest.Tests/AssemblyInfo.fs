...
[<assembly: AssemblyTitleAttribute("AltCoverTest.Tests")>]
[<assembly: AssemblyProductAttribute("AltCoverTest")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "AltCoverTest.Tests"
    let [<Literal>] AssemblyProduct = "AltCoverTest"
